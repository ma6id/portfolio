...
export default function ProjectModal({
  ...
  return (
    ...
    >
      ...
      >
        <div className="sticky top-0 z-10 flex items-center justify-between px-6 sm:px-8 py-5 border-b border-mist-500/10 bg-ink-900/70 backdrop-blur-md sm:rounded-t-3xl">
          <div>
